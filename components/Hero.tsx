  ...
  return (
    <section className="bg-[#f4f5f7] px-4">
      <div className="mx-auto grid min-h-[660px] max-w-7xl items-center gap-12 py-14 lg:grid-cols-[0.95fr_1.05fr] lg:py-20">
        <div>
          <p className="hero-kicker mb-5 inline-flex rounded-sm bg-red-50 px-4 py-2 text-sm font-bold text-brand-red ring-1 ring-red-100">
            Sale - Repair - Accessories
          </p>
          <h1 className="hero-title max-w-3xl text-5xl font-extrabold leading-[1.02] tracking-tight text-slate-950 md:text-7xl">
            M7 Bike <span className="text-brand-red">&</span> Scooters
          </h1>
          <p className="hero-copy mt-6 max-w-2xl text-lg leading-8 text-slate-600">
        ...
        <div className="relative">
          <div className="hero-media relative overflow-hidden rounded-md bg-slate-200 shadow-2xl">
            <Image
